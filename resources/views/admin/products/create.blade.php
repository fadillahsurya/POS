...
<div class="mb-4">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-white px-3 py-2 rounded shadow-sm mb-0">
      <li class="breadcrumb-item"><a href="{{ route('dashboard.admin') }}"><i class="bx bx-home"></i> Dashboard</a></li>
...
<div class="row justify-content-center">
  <div class="col-md-8 col-lg-7">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form id="formCreateProduct" method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
          @csrf
          ...
          {{-- Stok total (akan auto diisi bila pakai rasa) --}}
          <div class="mb-3">
            <label for="stok" class="form-label">Stok</label>
            <input type="number" name="stok" id="stok"
                   class="form-control @error('stok') is-invalid @enderror"
                   min="0" value="{{ old('stok') }}" required>
          ...
          <div class="mb-3">
            ...
            <div class="form-text">Harga tambahan per-rasa (jika ada) diisi di bagian “Pilihan Rasa”.</div>
          ...
          <div class="mb-2 form-check form-switch">
            <input class="form-check-input" type="checkbox" id="use_flavors">
            <label class="form-check-label" for="use_flavors">
              Produk punya variasi rasa
            </label>
          </div>

          <div id="flavorsSection" class="border rounded p-3 mb-4 d-none">
...
(function(){
  ...
  function toggleFlavorsUI() {
    ...
    if (on && tblBody.children.length === 0) addRow(); // siapkan satu baris awal
    recalcStock();
  }
  ...
  function recalcStock() {
    ...
    stokInput.value = total; // supaya lolos validasi 'stok' di backend
  }
  ...
  // Pastikan stok terset sebelum submit
